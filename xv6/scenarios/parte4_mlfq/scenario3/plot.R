...
escenarios <- c("cpubench_2iobench(c1)","cpubench_2iobench(i1)", "cpubench2_2iobench(c3)",
...
promedios <- c(c(c1,i1), c(c3,i3), c(i4), c(c5,i5), c(c6,i6), c(i7))
...
png(file = "plot_part4_es3.png")
bind_rows("cpubench y 2 iobench" = cpubench_2iobench,
          "2 cpubench y 2 iobench" = cpubench2_2iobench,
    ...
    ggplot(mapping = aes(x = V3)) +
        ...
        labs(title = "Comparación de escenarios (Parte 4, escenario 3)", y = "Número accesos", x= "Tipo de programa") 
dev.off()
