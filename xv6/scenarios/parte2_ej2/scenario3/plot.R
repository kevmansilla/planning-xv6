...
bind_rows(cpubench_2iobench = cpubench_2iobench,
          cpubench2_2iobench = cpubench2_2iobench,
    ...
    ggplot(mapping = aes(x = V3)) +
        ...
        labs(title = "Escenario 3: quantum 1000 veces más corto y tick de 2500", y = "Número de Operaciones (promedio)", x= "") 
dev.off()
